...
class MultiheadAttentionSiameseNet(BaseSiameseNet):
    ...
    def siamese_layer(self, sequence_len, model_cfg):
        ...
        out1, self.debug_vars['attentions_x1'] = stacked_multihead_attention(self.embedded_x1,
        ...
        out2, self.debug_vars['attentions_x2'] = stacked_multihead_attention(self.embedded_x2,
                                                                             num_blocks=num_blocks,
                                                                             num_heads=num_heads,
                                                                             use_residual=use_residual,
                                                                             is_training=self.is_training,
